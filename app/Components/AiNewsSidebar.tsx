// "use client";
// import { newspaper, aiIcon } from "@/app/utils/Icons";
...
//     if (isAIOpen) setIsAIOpen(false); // Close AIContent if it's open
//   };

//   const toggleAI = () => {
//     setIsAIOpen(!isAIOpen);
//     if (isNewsOpen) setIsNewsOpen(false); // Close News if it's open
//   };

//   return (
//     <div className="fixed top-1/2 right-0 -translate-y-1/2 flex flex-col items-center z-50 space-y-4">
//       <div
//         className={`transition-all duration-300 ease-in-out ${isNewsOpen ? 'mr-[300px]' : 'mr-0'}`}
//       >
//         <div
//           onClick={toggleNews}
//           className="sidebar-icon relative group cursor-pointer p-2 rounded-l-full bg-white shadow-sm text-3xl text-black"
//         >
//           {newspaper}
//         </div>
//       </div>
//       <div
//         className={`transition-all duration-300 ease-in-out ${isAIOpen ? 'mr-[300px]' : 'mr-0'}`}
//       >
//         <div
//           onClick={toggleAI}
//           className="sidebar-icon relative group cursor-pointer p-2 rounded-l-full bg-white shadow-sm text-3xl text-black"
...
//       </div>
//       <div
//         className={`fixed top-1/2 -translate-y-1/2 right-0 transition-all duration-300 ease-in-out ${isNewsOpen ? 'translate-x-0' : 'translate-x-full'}`}
//       >
//         <News />
//       </div>
//       <div
//         className={`fixed top-1/2 -translate-y-1/2 right-0 transition-all duration-300 ease-in-out ${isAIOpen ? 'translate-x-0' : 'translate-x-full'}`}
//       >
//         <AIContent /> {/* Placeholder for AI-related content */}
//       </div>
//     </div>
//   );
// };
